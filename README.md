...
Click on the green **Clone or download** button on the GitHub page and select **Download ZIP** from the menu that appears. Grab the `dropDMG` folder from the archive and add it to your applications `helpers` folder.
